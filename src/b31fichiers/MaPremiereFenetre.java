...
public class MaPremiereFenetre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ouverture d'un fichier");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        B31fichiers b = new B31fichiers();
        try {
            b.lectureEcriture(jTextArea1);
        } catch (IOException ex) {
            Logger.getLogger(MaPremiereFenetre.class.getName()).log(Level.SEVERE, null, ex);
        }
